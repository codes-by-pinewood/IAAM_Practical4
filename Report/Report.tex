...
\begin{figure}[h!]
\centering
\includegraphics[width=0.75\linewidth]{Images/fin.png}
\caption{\label{fig:ChoiceofCells-ControlSeries}The image shows the choice of cells in the \emph{Control Series}}
\end{figure}
